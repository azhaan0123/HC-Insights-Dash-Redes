// AUTO-GENERATED from Blank_US_Map_(states_only).svg
// Exact 50-State + DC authentic vector paths and internal state borders (viewBox: 0 0 959 593)

export type StatePathDef = {
  id: string;
  name: string;
  d?: string;
  type?: 'path' | 'circle';
...
export const US_50_STATE_PATHS: StatePathDef[] = [
  {
    "id": "AL",
    "name": "Alabama",
...
export const US_MAP_BORDERS: { id: string; d: string }[] = [
  {
    "id": "al-fl",
...
export const US_MAP_SEPARATOR = "m 215,493 v 55 l 36,45 m -251,-168 h 147 l 68,68 h 85 l 54,54 v 46";
