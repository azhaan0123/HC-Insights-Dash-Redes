...
export function ClassicLayout({
  ...
  const navIcons = [
    { icon: TrendingUp, label: "Action Centre", active: true },
  ];
  ...
  return (
    <div className="min-h-screen bg-[#f4f6f8] flex flex-col font-sans antialiased text-[#212529]">
      ...
      <header className="bg-white border-b border-[#dee2e6] px-6 py-2.5 flex items-center justify-between sticky top-0 z-50 shadow-2xs">
        ...
        <nav className="hidden xl:flex items-center gap-1.5 px-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <button className="size-7 rounded-full border border-[#dee2e6] flex items-center justify-center text-[#6c757d] hover:bg-[#f8f9fa] transition-colors">
      ...
      <main className="flex-1 px-6 py-5 max-w-[1600px] w-full mx-auto flex flex-col gap-4">
        ...
        {/* Filter Pills Bar - Exact Legacy Palette (#e9ecef background, #495057 text) */}
